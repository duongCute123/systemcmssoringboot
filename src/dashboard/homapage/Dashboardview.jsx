                    ...
                    <div className='flex items-center gap-[15px] relative' onClick={showProfile} >
...

                        {
                            ...
                            <div className='bg-white border h-[120px] w-[150px] absolute bottom-[-135px] z-20 right-0 pt-[15px] pl-[15px] space-y-[10px]'>
                                <p className='cursor-pointer hover:text-[blue] font-semibold' onClick={showProfiles}>Profile</p>
                                <p className='cursor-pointer hover:text-[blue] font-semibold'>Settings</p>
                                <p className='cursor-pointer hover:text-[blue] font-semibold' onClick={logoutsHandler}>Log out</p>
                            </div>
